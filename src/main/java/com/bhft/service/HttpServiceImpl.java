...
public class HttpServiceImpl implements HttpService {
    ...
    @Override
    public ValidatableResponse sendGet(int statusCode) {
        return given()
                .baseUri(URL)
                .when()
                .get(TODOS)
    ...
    public void sendPost(TodoModel todoModel, int statusCode) {
        given()
    ...
    public void sendPut(TodoModel todoModel, int statusCode) {
        given()
                .spec(defaultRequestSpecification(todoModel))
                .when()
    ...
    public void sendDelete(TodoModel todoModel, int statusCode) {
        given()
                .baseUri(URL)
                .auth()
                .preemptive()
    ...
    public List<TodoModel> sendGetOffsetAndLimit(int offset, int limit) {
